...
class TaskConfig:
    ...
    async def before_start(self):
        ...
        # USER_TRANSMISSION: якщо є преміум-сесія — завжди True (4 GiB сплітинг)
        self.user_transmission = TgClient.IS_PREMIUM_USER and bool(
            Config.USER_TRANSMISSION
            or self.user_dict.get("USER_TRANSMISSION")
        )
        ...
        if not self.is_leech:
            ...
            self.max_split_size = TgClient.MAX_SPLIT_SIZE  # 4 GiB при преміумі, 2 GiB без
